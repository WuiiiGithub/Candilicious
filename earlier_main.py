import os, sys, datetime # , cloud_setup
...
def log_board_activity(token, board_id):
    ...
    for log_entry in logs:
        ...
        log_entry["mac_id"] = None # Security restriction: MAC ID not available via browser
        log_entry["created_at"] = datetime.datetime.utcnow()

    boardsLogCollection.insert_many(logs)
    return jsonify({"status": "success"})
